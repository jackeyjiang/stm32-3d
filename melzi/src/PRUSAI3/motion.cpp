...
#if !NONLINEAR_SYSTEM
//===============================================================================
// 把目的脉冲 送入运行缓冲，如果缓存满了，程序等待直到有新的可以缓存空间
/**
...
//     }
    ...
    accelerationDistance2 = 2.0*distance*slowest_axis_plateau_time_repro*fullSpeed/F_CPU; // mm^2/s^2
...
//====================================================================
// 步进电机步进驱动信号 最后一个脉冲发完成则发下个块，程序在定时器循环中
// 执行，返回下次执行时间
//====================================================================
int lastblk=-1;
long cur_errupd;
uint16 PrintLine::bresenhamStep()   // version for cartesian printer
{
    if(cur == NULL) {
        setCurrentLine();
