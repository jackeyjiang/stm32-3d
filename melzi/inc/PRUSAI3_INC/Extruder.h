...
//  uint8_t invertDir; ///< 1 if the direction of the extruder should be inverted.
    ...
    */
    ...
    {
#if NUM_EXTRUDER==1
        digitalWrite(EXT0_STEP_PIN,HIGH);
#else
        ...
        case 0:
            ...
            if(Extruder::dittoMode) {
                digitalWrite(EXT1_STEP_PIN,HIGH);
            }
#endif
#endif
            break;
        ...
        case 2:
            digitalWrite(EXT2_STEP_PIN,HIGH);
            break;
#endif
#if defined(EXT3_STEP_PIN) && NUM_EXTRUDER>3
        case 3:
            digitalWrite(EXT3_STEP_PIN,HIGH);
            break;
#endif
#if defined(EXT4_STEP_PIN) && NUM_EXTRUDER>4
        case 4:
            digitalWrite(EXT4_STEP_PIN,HIGH);
            break;
#endif
#if defined(EXT5_STEP_PIN) && NUM_EXTRUDER>5
        case 5:
            digitalWrite(EXT5_STEP_PIN,HIGH);
            break;
#endif
        }
#endif
    ...
    */
    ...
    {
#if NUM_EXTRUDER==1
        digitalWrite(EXT0_STEP_PIN,LOW);
#else
        switch(Extruder::current->id)
        {
        case 0:
...
#if FEATURE_DITTO_PRINTING
            if(Extruder::dittoMode) {
                digitalWrite(EXT1_STEP_PIN,LOW);
            }
#endif
#endif
            break;
...
#if defined(EXT2_STEP_PIN) && NUM_EXTRUDER>2
        case 2:
            digitalWrite(EXT2_STEP_PIN,LOW);
            break;
#endif
#if defined(EXT3_STEP_PIN) && NUM_EXTRUDER>3
        case 3:
            digitalWrite(EXT3_STEP_PIN,LOW);
            break;
#endif
#if defined(EXT4_STEP_PIN) && NUM_EXTRUDER>4
        case 4:
            digitalWrite(EXT4_STEP_PIN,LOW);
            break;
#endif
#if defined(EXT5_STEP_PIN) && NUM_EXTRUDER>5
        case 5:
            digitalWrite(EXT5_STEP_PIN,LOW);
            break;
#endif
        }
#endif
    ...
    static inline void setDirection(uint8_t dir)
    {
#if NUM_EXTRUDER==1
        if(dir)
            digitalWrite(EXT0_DIR_PIN,!EXT0_INVERSE);
        else
            digitalWrite(EXT0_DIR_PIN,EXT0_INVERSE);
#else
        switch(Extruder::current->id)
        ...
        case 0:
            ...
            if(Extruder::dittoMode) {
                if(dir)
                    digitalWrite(EXT1_DIR_PIN,!EXT1_INVERSE);
                else
                    digitalWrite(EXT1_DIR_PIN,EXT1_INVERSE);
            }
#endif
        ...
        case 2:
            if(dir)
                digitalWrite(EXT2_DIR_PIN,!EXT2_INVERSE);
            else
                digitalWrite(EXT2_DIR_PIN,EXT2_INVERSE);
            break;
#endif
        ...
        case 3:
            if(dir)
                digitalWrite(EXT3_DIR_PIN,!EXT3_INVERSE);
            else
                digitalWrite(EXT3_DIR_PIN,EXT3_INVERSE);
            break;
#endif
        ...
        case 4:
            if(dir)
                digitalWrite(EXT4_DIR_PIN,!EXT4_INVERSE);
            else
                digitalWrite(EXT4_DIR_PIN,EXT4_INVERSE);
            break;
#endif
        ...
        case 5:
            if(dir)
                digitalWrite(EXT5_DIR_PIN,!EXT5_INVERSE);
            else
                digitalWrite(EXT5_DIR_PIN,EXT5_INVERSE);
            break;
#endif
    ...
    static inline void enable()
    {
        ...
        digitalWrite(EXT0_ENABLE_PIN,EXT0_ENABLE_ON );
#endif
#else
